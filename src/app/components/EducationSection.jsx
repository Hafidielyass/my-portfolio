...
const EducationSection = () => {
  return (
    <section className="font-AlbertSans">
      <h2 className="text-primary-950 text-5xl font-Gaegu font-extrabold mb-1 mt-5 ">Eduction</h2>
        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2">
          <div className="flex flex-row-reverse md:contents">
            <div className="w-full col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto border border-mercury-100 bg-second-50 ">
              <h3 className="font-semibold text-lg mb-1 text-primary-950">
            ...
            <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
              <div className="h-full w-6 flex items-center justify-center">
                <div className="h-full w-[1px] bg-mercury-200 pointer-events-none"></div>
              </div>
